...
;**************************************************************
function orcaobs,file=filename,nimg=nimg,nowait=nowait,noread=noread
  ...
  if nimg gt 1 then imgs=uintarr(p.width,p.height,nimg)
