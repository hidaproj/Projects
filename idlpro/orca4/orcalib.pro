...
; 2017.05.01  k.o.,k.i.         extrig keyword and additional wait for trig mode in orcaobs
; 2017.05.03  k.i.		orca_capturemode_snap,nimg=nimg in orcaobs, solve OrcaWait and remove change on 2017.05.01
...
function orcaobs,file=filename,nimg=nimg,nowait=nowait,noread=noread,grabimg_wait=grabimg_wait
  ...
  orca_capturemode_snap,nimg=nimg
