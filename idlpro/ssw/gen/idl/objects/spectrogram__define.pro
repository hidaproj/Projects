...
; Time-stamp: <Fri May 27 2005 10:12:25 csillag soleil.ifi.fh-aargau.ch>
;---------------------------------------------------------------------------
;+
; PROJECT:
;       HESSI / PHOENIX
...
;       Check soleil.ifi.fh-aargau.ch/~csillag/rhessi/spectrogram.html
;       fro more infromation
;
; CATEGORY:
;       generic utilities
;
...
;    endif
    ...
    if keyword_set(plotman_obj) then begin
	   ...
	   if status then begin
	      ...
	      plotman_obj -> new_panel, 'Spectrogram'
	   endif
