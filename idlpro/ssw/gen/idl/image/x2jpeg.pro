...
a = tvrd(0,0,!d.x_size,!d.y_size,true=true)
if not true then begin
    tvlct, r, g, b, /get
    sz = size(a)
    temp = bytarr(3,sz(1),sz(2))
    temp(0,*,*) = r(a)
    temp(1,*,*) = g(a)
    temp(2,*,*) = b(a)
    a = temporary(temp)
...
if n_elements(resize) eq 2 then begin
	...
	temp = bytarr(3,resize(0),resize(1))
	for i=0,2 do temp(i,*,*) =	$
...
write_jpeg, form_filename(file,'.jpg'), a, true=1,quality=100
