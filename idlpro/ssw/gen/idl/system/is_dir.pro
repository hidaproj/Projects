...
;               Modified, 17-Aug-2005, Zarro (L-3Com/GSFC) - added call
;                to FILE_TEST for version > 5.3
...
function is_dir,name,out=out,count=count,err=err,expand=expand
...
if np gt 1 then begin
 ...
 for i=0,np-1 do begin
  bool[i]=is_dir(name[i],out=tout,err=err,expand=expand)
  out[i]=tout
 endfor
...
if since_version('5.4') then return,call_function('file_test',cname,/dir)
