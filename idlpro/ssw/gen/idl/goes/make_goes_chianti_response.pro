...
;------------------------------------------------------------------------
;
; Type ".run make_goes_chianti_responses" and then
;
;        "make_goes_chianti_responses"
;
...
;+
; NAME:    GOES_TF_COEFF
;   Richard/Roger's goes_tf_coeff with GOES 12 added, GOES 11 same as GOES 10
...
gbshort = 1e-5*[1.27,1.25,1.25,1.73,1.74,1.74,1.68,1.580,1.607,1.631,1.631,1.595]
gblonga = 1e-6*[4.09,3.98,3.98,4.56,4.84,5.32,4.48,4.165,3.990,3.824,3.824,4.090]
...
tl = [ 1.84e-8, 1.32e-7, $
  ...
  5.39e-6, 3.78e-6, 3.90e-6, 3.98e-6, 4.02e-6, 4.10e-6, 3.96e-6, 3.88e-6, $
