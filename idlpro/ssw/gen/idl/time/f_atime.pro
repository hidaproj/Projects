...
if keyword_set(yohkoh) then begin
	...
	temp = (tarr(6,*))(*)
	if keyword_set(y2k) then yy=string(temp,'(i4.4)') else $
		yy = string(temp mod 100, '(i2.2)')
	mm=strmid(string((tarr(5,*))(*)+100,'(i3)'),1,2) ; 01 through 12
	HHMM=strmid(string(100*(tarr(0,*))(*)+(tarr(1,*))(*)+10000,'(i5)'),1,4)
	SS=strmid(string( (tarr(2,*) + tarr(3,*)/1.d3)(*) + 100,'(f8.3)'),2,6)
	dd=strmid(string((tarr(4,*))(*)+100,'(i3)'),1,2) ;01 through 28,...31
