...
nparams=n_params()
if n_elements(p0) ne 0 then heap_free,ptr_new(p0,/no_copy)
if nparams eq 1 then return

if n_elements(p1) ne 0 then heap_free,ptr_new(p1,/no_copy)
if nparams eq 2 then return

if n_elements(p2) ne 0 then heap_free,ptr_new(p2,/no_copy)
if nparams eq 3 then return

if n_elements(p3) ne 0 then heap_free,ptr_new(p3,/no_copy)
if nparams eq 4 then return

if n_elements(p4) ne 0 then heap_free,ptr_new(p4,/no_copy)
if nparams eq 5 then return

if n_elements(p5) ne 0 then heap_free,ptr_new(p5,/no_copy)
if nparams eq 6 then return

if n_elements(p6) ne 0 then heap_free,ptr_new(p6,/no_copy)
if nparams eq 7 then return

if n_elements(p7) ne 0 then heap_free,ptr_new(p7,/no_copy)
if nparams eq 8 then return

if n_elements(p8) ne 0 then heap_free,ptr_new(p8,/no_copy)
if nparams eq 9 then return

if n_elements(p9) ne 0 then heap_free,ptr_new(p9,/no_copy)
