...
;**************************************************************************
pro mmsp_hagi_event, ev1
common mmsp_com, wd, p, wl, sp1, drk, dat, clr, outfile0, npix

case strtrim(npix,2) of
	'2048' : yrange=[0,16384.]
	'2068' : yrange=[0,65536.] ;;;fixed yrange
endcase
iobit=1
...
inst=dialog_menu(['HR2000','Maya2000'],title='select the spectrometer')
...
wl=hr_getwl(npix=npix)	; wavelength array [2048]
hr_setexpo,expo
pm=emp_ctl()
