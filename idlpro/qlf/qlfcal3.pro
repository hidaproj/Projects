...
for j=0,nwl2-1 do begin
   ...
   plot,wl,spec[*,j]-dark,title='orignal setting @'+string(wl2[j],form='(i4)')+' nm',xtit='nm',yra=[1,2l^16-1], $
   ...
   write_gif,'orignal.gif',tvrd(),/multi
...
write_gif,'original.gif',/close
save,file='original.sav',bits,spec
...
plot_image,cspec2,scale=[dwl3,dwl],orig=[wl3[0],wl2[0]], $
	title='Tuning transmission profile (original)', $
...
colorbar,position=clip[[2,1,2,3]]+[0.02,0,0.05,0],/vertical, $
	...
	range=dra,form='(f5.3)'
write_png,'original.png',tvrd(/true)
