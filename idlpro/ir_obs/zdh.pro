...
;wset,0 & plot,wh,haarr(wh),xrange=[0,100],psym=2,/ynozero,title='Hour Angle [sec]',xtitle='Time [3sec]',chars=1 & oplot,wh,haarr(wh)
;xyouts,100,450,time2,chars=1,/device
;wset,1 & plot,wz,zdarr(wz),xrange=[0,100],psym=4,/ynozero,title='Zenith Distance [arcsec]',xtitle='Time [3sec]',chars=1 & oplot,wz,zda;rr(wz)
;xyouts,100,450,time2,chars=1,/device
window,2

;====outarr=====;
;hour angle => haarr
;Zenith distance => zdarr
;===============;
xyouts,50,410,'HOUR ANGLE',chars=2,/dev,charthick=2
xyouts,80,310,hastr,chars=3,/dev,charthick=4
xyouts,50,190,'ZENITH DISTANCE',chars=2,/dev,charthick=2
xyouts,80,90,zdstr,chars=3,/dev,charthick=4
