...
;**************************************************************
function hshabar_hagi_ctl	; return CAIO control parameter structure

c=caio_cardst()

p={hshabar_hagi_ctl, $	; hshabar_hagi control params.
...
;**************************************************************
pro hshabar_hagi_event, ev
;--------------------------------------------------------------
common hshabar_hagi, wd, p, dat
;  wd  -- widget
...
;**************************************************************
function widget_hshabar_hagi,base,p	; display widget status
;--------------------------------------------------------------
...
wd = widget_hshabar_hagi(base,p)
wd.Exit=widget_button(base, value="Exit", uvalue = "Exit")
widget_control, base, /realize
XMANAGER, 'hshabar_hagi', base
