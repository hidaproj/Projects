...
wdef,0,512,512
ww=200
rimg1=congrid(rimg0[ww:2048-ww,ww:2048-ww],2048,2048)
rr=round(max(rimg1)/100)*100
tv,cscale(rebin(rimg1,512,512),drange=rr+[-900,0])
tit='data50_'+string(j+1,form='(i3.3)')+' '$
             +f.time+' !4k!3='+strtrim(string(f.wl0,form='(f6.2)'),2)+'A'
     xyouts,10,10,tit,/dev,charsize=2,color=255
w_png,sdir+'dataset50_'+string(j+1,form='(i3.3)')+'_512_21.png'
save,filename=sdir+'dataset50_'+string(j+1,form='(i3.3)')+'_512_2.sav',p,rimg0,f,data
stop
endfor
